...
@media (max-width: 450px) {
  ...
  .closebtn {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "carousel", ref: carouselRef, children: videos.map((video, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-container", onClick: () => handleVideoClick(index), children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: (el2) => videoRefs.current[index] = el2, src: video, loop: true, muted: true, autoPlay: true, className: "vid" }) }, index)) }),
