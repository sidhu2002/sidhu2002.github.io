...
const volumeImage = "/volume.png";
const muteImage = "/mute.png";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "carousel-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        .carousel-container {
          position: relative;
          overflow: hidden;
          width: 100%; /* Ensure the carousel container has a fixed width */
        }
        ...
        .bookbtn {
          ...
          right: -1vh;
          position: absolute;
          top: 5vh; /* Move the div to the center horizontally */
        ...
        @media (max-width: 450px) {
          ...
          .img {
            ...
            transform: translateY(-50%); /* Adjust the position to center */
            left: 4%;
            width: 20%;
            border-radius: 5px;
          }
...
const Popup = ({ campaigns, currentIndex, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whole", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "prevbtn", onClick: handlePreviousCampaign, children: "<" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "closediv", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "closebtn", onClick: onClose, children: "X" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reelsContainer", children: campaigns[currentCampaignIndex].videoId.map((videoId, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "functions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: muteStatus[index] ? muteImage : volumeImage,
          className: "volume",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "nextbtn", onClick: handleNextCampaign, children: ">" })
  ] });
};
const App = () => {
  ...
  reactExports.useEffect(() => {
    const fetchVideoData = async () => {
      try {
        const response = await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/8b31bc80-7bfb-1fda-addd-4d3ef82c5f68`);
