...
@media (max-width: 450px) {
  ...
  .closebtn {
    ...
    showPrevButton && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "nav-btn", onClick: scrollLeft, children: "<" }),
    ...
    showNextButton && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "nav-btn", onClick: scrollRight, children: ">" }),
...
const Popup = ({ campaigns, currentIndex, onClose }) => {
  ...
  const [playStatus, setPlayStatus] = reactExports.useState([]);
      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          if (entry.isIntersecting) {
            entry.target.play();
            updatePlayStatus(index, true);
            setCurrentVideoIndex(index);
          } else {
            entry.target.pause();
            updatePlayStatus(index, false);
          }
        });
      },
      { threshold: 0.5 }
  ...
  reactExports.useEffect(() => {
    ...
    if (video) {
      video.play();
      updatePlayStatus(currentVideoIndex, true);
    }
  }, [currentVideoIndex]);
  const updatePlayStatus = (index, isPlaying) => {
    setPlayStatus((prevStatus) => {
      const newStatus = [...prevStatus];
      newStatus[index] = isPlaying;
      return newStatus;
    });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: popupRef, className: "whole", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reelsContainer", children: campaigns[currentCampaignIndex].videoId.map((videoId, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-container", children: [
        ...
        !playStatus[index] && /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: faPlay, onClick: () => handleVideoClick(index), className: "play-button" }),
