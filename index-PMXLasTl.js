...
const Carousel = ({ videos, campaigns }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "carousel-container", children: [
...
.play-button {
  ...
  max-height:10vh;
  transform: translate(-50%, -50%);
  font-size: 34px; /* Adjust the size of the play button */
  color: white;
...
.video-container {
  ...
  object-fit: cover;
  border-radius:20px;
  flex: 0 0 calc(20% - 10px); /* Adjust the width to fit 5 videos with a gap */
...
@media (max-width: 1200px) {
  .video-container {
    flex: 0 0 calc(25% - 10px); /* Adjust to 4 videos per view */
  }
}

@media (max-width: 900px) {
  .video-container {
    flex: 0 0 calc(33.33% - 10px); /* Adjust to 3 videos per view */
  }
}

@media (max-width: 600px) {
  .video-container {
    flex: 0 0 calc(50% - 10px); /* Adjust to 2 videos per view */
  }
}

@media (max-width: 400px) {
  .video-container {
    flex: 0 0 calc(100% - 10px); /* Adjust to 1 video per view */
  }
}
...
.video-container {
  ...
  .closebtn {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "nav-btn", onClick: scrollLeft, children: "<" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "carousel", ref: carouselRef, children: videos.map((video, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-container", onClick: () => handleVideoClick(index), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: (el2) => videoRefs.current[index] = el2, src: video, loop: true, muted: true, autoPlay: true, className: "vid" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "carousel-div", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "txt1", children: campaigns[index].campaignName }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "txt2", children: [
          "From ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "nav-btn", onClick: scrollRight, children: ">" }),
...
const Popup = ({ campaigns, currentIndex, onClose }) => {
  ...
  const handlePreviousCampaign = () => {
    const prevIndex = (currentCampaignIndex - 1 + campaigns.length) % campaigns.length;
  ...
  const requestFullScreen = () => {
    if (isMobile && popupRef.current) {
      ...
      } else if (popupRef.current.mozRequestFullScreen) {
        popupRef.current.mozRequestFullScreen();
      } else if (popupRef.current.webkitRequestFullscreen) {
        popupRef.current.webkitRequestFullscreen();
      } else if (popupRef.current.msRequestFullscreen) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: popupRef, className: "whole", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prevbtn", onClick: handlePreviousCampaign, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: faCircleChevronLeft }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "closediv", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "closebtn", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: faTimes }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reelsContainer", children: campaigns[currentCampaignIndex].videoId.map((videoId, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-container", children: [
        ...
        isVideoPaused && /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: faPlay, onClick: () => handleVideoClick(index), className: "play-button" }),
        index === 0 && showArrowIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: faAnglesDown, bounce: true, className: "down-arrow" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bookdiv", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hotelname", children: campaigns[currentCampaignIndex].campaignName }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "offer", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "view-more", onClick: toggleText, children: showFullText ? " View Less" : " View More" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divbtn", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: campaigns[currentCampaignIndex].campaignLink, target: "_blank", rel: "noopener noreferrer", className: "bookbtn", children: "Book" }) })
      ] })
    ] }, index)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nextbtn", onClick: handleNextCampaign, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: faCircleChevronRight }) })
  ] });
};
const App = () => {
